    ...
    def inpainting(self,image,mask_b,i): #MakGIT inference
        ...
        with torch.no_grad():
            ...
            for step in range(self.total_iter):
                ...
                z_indices_predict, mask_bc = self.model.inpainting(masked_z_indices, ratio, mask_bc, mask_num)
...
#TODO3 step1-2: modify the path, MVTM parameters
    ...
    #dataset path
    parser.add_argument('--test-maskedimage-path', type=str, default=f"{base_dir}/masked_image", help='Path to testing image dataset.')
    parser.add_argument('--test-mask-path', type=str, default=f"{base_dir}/mask64", help='Path to testing mask dataset.')
    #MVTM parameter
