...
def evaluate(args):
    ...
    for ep in range(args.episodes):
        ...
        with imageio.get_writer(out_path, fps=30, macro_block_size=1) as video:
            for f in frames:
                video.append_data(f)
        print(f"[environment steps: {step_count:3d}], [seed: {args.seed + ep:2d}], [eval reward: {total_reward}]")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="../LAB5_314551161_task1.pt", help="Path to trained .pt model")
