...
if __name__ == "__main__":
    ...
    parser.add_argument("--epsilon-decay", type=float, default=0.999995) # 0.999999
    parser.add_argument("--epsilon-min", type=float, default=0.01) # 0.05
    parser.add_argument("--target-update-frequency", type=int, default=4000) # 1000
    parser.add_argument("--replay-start-size", type=int, default=10000) # 50000
